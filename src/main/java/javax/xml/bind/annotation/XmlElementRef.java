 ...
 * {@code @XmlRootElement} annotation on its corresponding class.
 * <pre>
 ...
 *         {@code JAXBElement<? extends Operator>} term;
 *     }
 *
 *     {@code @XmlRegistry}
 *     class ObjectFactory {
 *         {@code @XmlElementDecl}(name="operator")
 *         {@code JAXBElement<Operator>} createOperator(Operator o) {...}
 *         {@code @XmlElementDecl}(name="add",substitutionHeadName="operator")
 *         {@code JAXBElement<Operator>} createAdd(Operator o) {...}
 *         {@code @XmlElementDecl}(name="sub",substitutionHeadName="operator")
 *         {@code JAXBElement<Operator>} createSub(Operator o) {...}
 *     }
 *
 *     class Operator {
 *         ...
